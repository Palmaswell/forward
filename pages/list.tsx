...
import { BuiltInConsumer, ColorManagerConsumer } from '../context';
import { ColorExtendedProps, ColorManagerContext } from '../color';
...
export default class List extends React.Component<ListPageProps> {
  ...
  private renderTopBar = (): JSX.Element => {
    return (
      <Component.Space
        size={[Component.Size.M, Component.Size.L, 0, Component.Size.L]}>
        <Component.TopBar>
